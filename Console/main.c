...
int main()
{
	...
	ecrire(L"\n  %ocMusiques :%ow\n");
	ecrire(L"    %ormusique d'introduction :%ow Entering the rat race - Overcolored\n");
	ecrire(L"    %ormusique de cheat code :%ow Bust this bust that - Professor Klick\n");
	ecrire(L"    %ormusique du magasin :%ow Pizzicato - Ehma\n");
	ecrire(L"    %ormusique de combat 1 :%ow Partie au loin - Chriss Onac\n");
	ecrire(L"    %ormusique de combat 2 :%ow My Arrival - Obsidian Shell\n");
	ecrire(L"    %ormusique du boss :%ow No time - Petite Viking\n");
	ecrire(L"    Tous les droits d'auteurs li\x82s \x85 ces musiques sont respect\x82s. Vous pouvez\n");
	ecrire(L"    trouver les musiques et plus de d\x82tails sur les licenses sur le site de\n");
	ecrire(L"    musiques Jamendo (%oghttp://Jamendo.com%ow)\n");
	...
	ecrire(L"  jour. (%oghttp://siteduzero.com%ow)\n");
